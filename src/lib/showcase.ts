// Showcase CPT (34 published items). Categories are Automotive, Medical,
// Defense, and Consumer Electronics; everything else is tagged "Other" (shown
// with a blue pill). `award` items get a gold "Award Winning" corner banner.
